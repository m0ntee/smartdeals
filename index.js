...
bot.on("message:text", async (ctx) => {
    ...
    userLastMessages.set(ctx.from.id, ctx.message);
    await ctx.reply(`Ваш заказ:\n\n3 курс ⭐️⭐️⭐️\nПредмет - ТУС 🚢\nКурсовая работа 🎯\nСтоимость: 2190₽\nДанные для расчёта:\n${ctx.message.text}\n\nДля оплаты заказа переведите 2190₽ на номер карты: 2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`,{
        parse_mode: `HTML`,
    ...
    if (ctx.session.order12?.waitingForData12) {
        userLastMessages.set(ctx.from.id, ctx.message);
        await ctx.reply(`Ваш заказ:\n\n3 курс ⭐️⭐️⭐️\nПредмет - МОС 🧮\nПоток: Море 🌊\nЗадание: Курсовая работа 🚢\nСтоимость: 1790₽\nДанные для расчёта:\n${ctx.message.text}\n\nДля оплаты заказа переведите 1790₽ на номер карты: 2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`,{
            parse_mode: `HTML`,
    ...
    if (ctx.session.order14?.waitingForData14) {
        userLastMessages.set(ctx.from.id, ctx.message);
        await ctx.reply(`Ваш заказ:\n\n3 курс ⭐️⭐️⭐️\nПредмет - МОС 🧮\nПоток: Река-море 🌉🌊\nЗадание: ПЗ №2. Сферические треугольники\nСтоимость: 590₽\nВаш вариант:\n${ctx.message.text}\n\nДля оплаты заказа переведите 590₽ на номер карты: 2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`,{
            parse_mode: `HTML`,
    ...
    if (ctx.session.order17?.waitingForData17) {
        userLastMessages.set(ctx.from.id, ctx.message);
        await ctx.reply(`Ваш заказ:\n\n3 курс ⭐️⭐️⭐️\nПредмет - Безопасность судоходства на ВВП🛟\nОпределение высоты подмостового габарита🌉\nСтоимость:890₽\nДанные для расчёта:\n${ctx.message.text}\n\nДля оплаты заказа переведите 890₽ на номер карты: 2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`,{
            parse_mode: `HTML`,
    ...
    if (ctx.session.order18?.waitingForData18) {
        userLastMessages.set(ctx.from.id, ctx.message);
        await ctx.reply(`Ваш заказ:\n\n3 курс ⭐️⭐️⭐️\nПредмет - Общая лоции ВВП 🌉\nПЗ "Расчёт линейного навигационного створа"\nСтоимость:790₽\nВаш вариант:\n${ctx.message.text}\n\nДля оплаты заказа переведите 790₽ на номер карты: 2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`,{
            parse_mode: `HTML`,
...
bot.callbackQuery('ok', async (ctx) => {
    if (ctx.session.order8.step8 === 2) {
        await ctx.reply(`Предмет - МСС 📏\nИтоговый тест по МСС 🖥️\nСтоимость: 490₽\nВаша почта: ${ctx.session.order8.email8}\nДля оплаты заказа и получения доступа переведите 490₽ на номер карты:\n2200701713115514\nПосле оплаты отправьте скиншот перевода нашему менеджеру✍: <a href="https://t.me/SmartDealsManager">ссылка</a>`, {
            parse_mode: `HTML`,
